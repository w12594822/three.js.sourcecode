...
THREE.MeshBasicMaterial = function ( parameters ) {
	...
	***************************************************************************************************************************/
	...
	this.alphaMap = null;	//透明通道提额度,默认为null
	...
	*********************着色方式**************************************************************************/
	...
	this.vertexColors = THREE.NoColors;//顶点颜色,默认初始化为THREE.NoColors.当然还可以有THREE.NoColors / THREE.VertexColors / THREE.FaceColors等选项,这里显示出了javascript的灵活性了.
...
THREE.MeshBasicMaterial.prototype.clone = function () {
	...
	return material;	//返回克隆的MeshBasicMaterial对象
