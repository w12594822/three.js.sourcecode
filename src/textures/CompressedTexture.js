...
///
*/
///<summary>CompressedTexture</summary>
///<param name ="mipmaps" type="Number">mipmaps图像对象,WebGL不能生成mipmaps,mipmaps只能嵌入到DDS文件</param>
///<param name ="width" type="Number">mipmaps图像宽度</param>
///<param name ="height" type="Number">mipmaps图像高度</param>
...
///<returns type="CompressedTexture">返回创建的纹理对象</returns>
...
/*************************************************
****下面是CompressedTexture对象的方法属性定义,继承自Texture
**************************************************/
...
///<param name ="texture" type="CompressedTexture">接受结果的压缩的纹理对象</param>
///<returns type="CompressedTexture">返回压缩的纹理对象</returns>	
