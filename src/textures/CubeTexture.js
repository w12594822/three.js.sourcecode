...
///从url中生成一个texture，需要调用Three.ImageUtils.loadTextureCube(paras)，
...
///<param name ="images" type="ImageArray">JavaScript Image类型对象数组,数组长度为6</param>
...
///<returns type="CubeTexture">返回创建的纹理对象</returns>
THREE.CubeTexture = function ( images, mapping, wrapS, wrapT, magFilter, minFilter, format, type, anisotropy ) {

	THREE.Texture.call( this, images, mapping, wrapS, wrapT, magFilter, minFilter, format, type, anisotropy );	//调用Texture对象的call方法,将原本属于Texture的方法交给当前对象CubeTexture来使用.

	this.images = images;	//赋值this.images属性数组

};

/*************************************************
****下面是CubeTexture对象的方法属性定义,继承自Texture
**************************************************/
...
///<param name ="texture" type="DataTexture">接受结果的纹理对象立方体</param>
///<returns type="DataTexture">返回纹理对象立方体</returns>	
